...
const MissVisProgramOfferedCon = ({ programTitle, programDesc, sDim, wDim, navigation, progId }) => {

  return (
    <TouchableOpacity style = {{ marginBottom : (wDim.height * 0.02) }} onPress = { () => navigation.navigate('ComponentView', { screen : 'MissVissHymnView', programTitle, content : programDesc, progId }) }>
        <View style = {{ 
          borderBottomWidth : 1,
...
export default MissVisProgramOfferedCon;
