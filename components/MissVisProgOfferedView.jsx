...
import MissVisProgramOfferCon from './sub/MissVisProgramOfferCon';
...
const MissVisProgOfferedView = ({ navigation, sDim, wDim, deptId, deptImg }) => {
...
export default MissVisProgOfferedView;
