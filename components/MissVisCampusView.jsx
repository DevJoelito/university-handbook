...
import MissVisCampusCon from './sub/MissVisCampusCon';
...
const getDeptName = async () => {
  try {
    let result = await fetch(`https://evsuhandbooksite.000webhostapp.com/sites/evsu_handbook/api/get_handbook.php?campus_list=1`);
...
const MissVisCampusView = ({ navigation, sDim, wDim }) => {  
      ...
      <View style = {{ 
        ...
        flex         : 1 }}>
        {
          ...
          <View>
            ...
            <FlatList
              data       = { campusNames }
              renderItem = { ({ item }) => { return (<MissVisCampusCon 
...
export default MissVisCampusView;
