...
import MissVisDepartmentCon from './sub/MissVisDepartmentCon';
...
const MissVisDeptView = ({ navigation, sDim, wDim, campId }) => {  
      ...
      <View style = {{ 
        ...
        flex         : 1 }}>
        {
          ...
          <View>
            ...
            <FlatList
              data       = { deptNames }
              renderItem = { ({ item }) => { return (<MissVisDepartmentCon 
...
export default MissVisDeptView;
